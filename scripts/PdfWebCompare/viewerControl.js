...
window.addEventListener('load', function webViewerLoad(evt) {
 ...
 // alert(PDFURL);
  //var PDFURL = document.getElementById('ctl00_ContentPlaceHolder1_pdfCtrl_FileLoadPath').value;
  //

  var file = PDFJS.isFirefoxExtension ? window.location.toString() : params.file || PDFURL;
...
/*
  if (cmd == 0) { // no control key pressed at all.
    switch (evt.keyCode) {
      case 120: // Enter key do nothing
      case 13: // Enter key do nothing
        alert("Case 13");
//        PDFView.page--;
//        handled = true;
//        break;
