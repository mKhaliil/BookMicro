...
namespace Outsourcing_System
{
    public class GlobalVar
    {
        ...
        //        if (pChildNode.Name.Equals("section-title"))
        //        {
        //            XmlNode section = pChildNode.SelectSingleNode("//descendant::section");
        //            string sectiontype = "";
        //            if (section != null && (section.Attributes["type"] != null))
        //            {
        //                sectiontype = section.Attributes["type"].Value;
        //            }
        //            parentNode = treeDoc.CreateElement(sectiontype);
        //            parentNode.SetAttribute("outerxml", pChildNode.SelectSingleNode("//descendant::section-title").InnerText);
        //        }
        //        else
        //        {
        //            parentNode = treeDoc.CreateElement(pChildNode.Name);
