    ...
    public partial class ImageTest : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (fZipUpload.HasFile)
            {
                ...
                if (Session["UserDetail"] != null)
                {
                    ...
                    List<TestDetail> testDetails = objMyDBClass.getTestDetails(userid, "Images");

                    string userDir_Path = objMyDBClass.MainDirPhyPath + "\\Tests\\" + currentUser.Email + "\\ImageTests\\" + testDetails[0].testName.Replace(".pdf", "") + "//";
                    ...
                    objMyDBClass.updateOnlineTestDetails("Images", currentUser.UserId, "Pending Confirmation", System.DateTime.Now.ToString());
        ...
        protected void lnkAssignedTest_Click(object sender, EventArgs e)
        {
            ...
            if (Session["UserDetail"] != null)
            {
                ...
                string filePath = "D://Files/Tests/Original/Image//";
        ...
        protected void lnkTest_Click(object sender, EventArgs e)
        {
            ...
            if (Session["UserDetail"] != null)
            {
                ...
                else
                {
                    ...
                    {
                        objMyDBClass.insertOnlineTestDetails("Image", currentUser.UserId, fileName, "In Process", System.DateTime.Now.ToString());
                        lnkTest.Visible = false;
                        ConfirmationPnl.Visible = true;

                        string filePath = "D://Files/Tests/Original/Image//"; 
                        //string filePath = "D://Office Data/Files/Tests/Original/Image//";
                        Context.Response.Clear();
                        Context.Response.ContentType = "application/pdf";
