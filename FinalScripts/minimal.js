...
window.onload = function () {
    ...
    PDFJS.workerSrc = 'FinalScripts/pdf.worker.js'; /// <reference path="pdf.worker.js" />
...
//        document.getElementById('divOuter').fadeOut(400);
        var pdfPath = document.getElementById('hfFileLoadPath').value;
    ...
    function setDivDimensions(viewport) {
        ...
        document.getElementById('divOuter').style.width = 2 * width + 'px';

        //        document.getElementById('frameWrap').style.width = 2 * width + 'px'; 

//        $("#srcImage").prop("onclick", false);
        
        //document.getElementById("ibtnPrevious").style.display = 'none';
        //document.getElementById("ibtnNext").style.display = 'none';


        document.getElementById('tdSrcImage').style.width = width + 'px';
        document.getElementById('tdSrcImage').style.height = height + 'px';
        document.getElementById('srcImage').style.width = width + 'px';
        document.getElementById('srcImage').style.height = height + 'px';

        document.getElementById('srcImage').style.display = 'inline';
...
//        $('#tdSrcImage').width(width);
//        $('#tdSrcImage').height(height);
//        $('#srcImage').width(width);
//        $('#srcImage').height(height);
//        $('#tdPrdPdf').width(width);
//        $('#tdPrdPdf').height(height);
//        $('#pdfContainer').width(width);
