    ...
    public partial class TableTest : System.Web.UI.Page
    {
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (fZipUpload.HasFile)
            {
                if (Session["UserDetail"] != null)
                {
                    ...
                    List<TestDetail> testDetails = objMyDBClass.getTestDetails(userid, "Tables");

                    string userDir_Path = objMyDBClass.MainDirPhyPath + "\\Tests\\" + currentUser.Email + "\\TableTests\\" + testDetails[0].testName.Replace(".pdf", "") + "//";
                    ...
                    objMyDBClass.updateOnlineTestDetails("Tables", currentUser.UserId, "Pending Confirmation", System.DateTime.Now.ToString());
                }
        ...
        protected void lnkAssignedTest_Click(object sender, EventArgs e)
        {
            if (Session["UserDetail"] != null)
            {
                ...
                string filePath = "D://Files/Tests/Original/Table//";
                //string filePath = "D://Office Data/Files/Tests/Original/Table//";
        ...
        protected void lnkTest_Click(object sender, EventArgs e)
        {
            ...
            if (Session["UserDetail"] != null)
            {
                ...
                else
                {
                    ...
                    {
                        objMyDBClass.insertOnlineTestDetails("Table", currentUser.UserId, fileName, "In Process", System.DateTime.Now.ToString());
