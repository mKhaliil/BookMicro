<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/OnlineTestMasterPage.Master" AutoEventWireup="true"
    CodeBehind="Step2.aspx.cs" Inherits="Outsourcing_System.Step2" %>
...
//                window.location = "Step3.aspx";
            ...
            function Timer() {
                ...
                document.getElementById('mid').setAttribute("style", "float: left;margin-top:-200px;");
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Panel ID="frmBookPreview" runat="server" DefaultButton="btnGenerate">
       ...
       <asp:HiddenField runat="server" ID="timehdnmin" />
        ...
        <asp:Label ID="lblTimeRemaining" runat="server" Style="margin-left: 35%; color: red;
        ...
        <table id="Table1" width="100%" cellpadding="2" cellspacing="0" style="margin-top: 2px">
            <tr class="td">
                <th>
                    Source File Preview
                </th>
            ...
            <tr>
                ...
                <td align="center">
                    ...
                    <asp:ImageButton ID="btnAddTable" Width="25" Visible="false" Height="15" runat="server"
                        ImageUrl="img/table.png" OnClientClick="ShowLoadingGif();" OnClick="btnAddTable_Click" />
                    <asp:ImageButton ID="btnDelTable" Width="25" Height="15" Visible="false" runat="server"
                    ...
                    <asp:ImageButton ID="btnAddBox" runat="server" Visible="false" ImageUrl="img/box.png"
                        Width="25" Height="15" OnClientClick="ShowLoadingGif();" OnClick="btnAddBox_Click" />
                    <asp:ImageButton ID="btnAddImage" runat="server" Visible="false" ImageUrl="img/image.gif"
