<%@ Page Title="" Language="C#" MasterPageFile="UserMaster.Master"
    AutoEventWireup="true" CodeBehind="ImageTest.aspx.cs" Inherits="Outsourcing_System.TestPages.ImageTest" %>
...
<asp:Content ID="ContentBody" ContentPlaceHolderID="mainBodyContents" runat="server">
    ...
    <div style="border-radius: 15px; border: 3px solid gray; width: 60%; margin: auto;
        padding: 25px;">
        <asp:LinkButton ID="lnkTest" runat="server" Font-Size="X-Large" Text="Click here to get an Image test."
        ...
        <div id="ConfirmationPnl" runat="server">
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <h5>
                            If you have done your test Please make a zip file of All Images, and Upload it Here.</h5>
                    </td>
                </tr>
                <tr>
                    <td>
